...
<div id="content">
	...
	<div id="page-title-active">Readers</a></div>
	<div id="page-title"><a href="list_books.php">Books</a></div>
	<div id="page-content">
		<div id="page-header">List all readers</div>
		<div id="sidebar">
			<span class="msgbox">
				<span style="color: #fc661c">Tips!</span><br/>This section will list all records.
			</span>
		</div>
		<p>In this section, you can list all readers, edit a record, or delete a record.</p>
